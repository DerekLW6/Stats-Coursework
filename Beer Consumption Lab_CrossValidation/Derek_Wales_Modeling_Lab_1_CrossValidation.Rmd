...
---
title: "Beer Consumption Lab (Cross Validation)"
author: "Derek Wales"
date: "06SEP19"
output:
...
The most meaningful predictors for Beer consumption in San Paulo seem to be
rising temperatures and whether or not its a weekend.
...
### Question 3: Does it make sense to include all three of temp_median_c, temp_min_c and temp_max_c as 
...
No because all of these are correlated which will violate one of the assumptions 
for using a Linear Model.
...
The Adjusted R-Squared value is 0.6554 which means that our model matches real life 65.54%
percent of the time. 
...
It is not a time series, it does not account for Temperature and percipitation which are 
often effected by the previous day. Additionally it doesn't account for holidays.
...
# Abhishek Baral (MIDS 2021) assisted in developing the for loop/troubleshooting this question.
